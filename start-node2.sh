...
# Script para iniciar Node 2 com API
...
echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}   Starting Krakovia Node 2${NC}"
echo -e "${BLUE}=========================================${NC}"
echo ""
...
echo -e "  - Node ID: ${BLUE}node2${NC}"
echo -e "  - P2P Port: ${BLUE}9002${NC}"
echo -e "  - API Port: ${BLUE}8081${NC}"
echo -e "  - API URL: ${BLUE}http://localhost:8081${NC}"
...
# Iniciar o nó
./bin/node -config configs/node2-api.json $MINE_FLAG
