...
# Script para iniciar Node 3 com API
...
echo -e "${BLUE}=========================================${NC}"
echo -e "${BLUE}   Starting Krakovia Node 3${NC}"
echo -e "${BLUE}=========================================${NC}"
echo ""
...
echo -e "  - Node ID: ${BLUE}node3${NC}"
echo -e "  - P2P Port: ${BLUE}9003${NC}"
echo -e "  - API Port: ${BLUE}8082${NC}"
echo -e "  - API URL: ${BLUE}http://localhost:8082${NC}"
...
# Iniciar o nó
./bin/node -config configs/node3-api.json $MINE_FLAG
